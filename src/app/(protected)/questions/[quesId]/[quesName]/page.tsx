...
import { answerCollection, questionCollection, db, questionsAttachmentBucket, voteCollection, commentCollection } from '@/models/name'
...
async function page({
  ...
  const [question, answers, upvotes, downvotes, comments] = await Promise.all([
    ...
    databases.listDocuments(db, "comments", [
      Query.equal("typeId", params.quesId),
      Query.equal("type", "question"),
      Query.orderDesc("$createdAt"),
    ]),
  ...
  /// fetch the author from the question document author id 

  const author = await users.get<UserPrefs>(question.authorId);

  // set authors of answers and question to their documents
