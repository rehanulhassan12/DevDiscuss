...
export default function QuestionCard({ question }: { question: Models.Document }) {
  ...
  return (
    <div
      ...
      <BorderBeam size={height} duration={11} delay={8} />

      <div className="relative shrink-0 text-sm sm:text-right">
        <p>{question.totalVotes || 0} votes</p>
        <p>{question.totalAnswers || 0} answers</p>
      </div>
